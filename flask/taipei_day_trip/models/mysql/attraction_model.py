...
from taipei_day_trip.models.mysql.attraction_image_model import (
    MySQLAttractionImageModel,
)
...
class MySQLAttractionModel(MySQLModel, AttractionModel):
    ...
    def add_operation(
        ...
        if mrt == None:
            ...
            ).format(attraction=self.tablename, category=self.category_tablename)
            data = (
                name,
                description,
                address,
